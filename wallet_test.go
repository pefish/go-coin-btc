...
func TestWallet_SeedHexByMnemonic(t *testing.T) {
	...
	test.Equal(t, "da2a48a1b9fbade07552281143814b3cd7ba4b53a7de5241439417b9bb540e229c45a30b0ce32174aaccc80072df7cbdff24f0c0ae327cd5170d1f276b890173", seedHex)
}
...
func TestWallet_MasterKeyBySeed(t *testing.T) {
	...
	test.Equal(t, "xprv9s21ZrQH143K4NSncMZfe2TMny1RNgsm3FC8iK3de44ppftiDUGAmkQGQLmdSDK64zXwSMGPkY1eUzKcSgBrq67Lt7jDvefVmDYy1Xb167R", masterKey.XPriv)
	test.Equal(t, "xpub661MyMwAqRbcGrXFiP6g1AQ6Lzqun9bcQU7jWhTFCPbohUDrm1aRKYikFcvFarQDuGhofh8kFDbGBvJYXGLiZSShpf6azvb2jHfHWYUQUoi", masterKey.XPub)
	test.Equal(t, "793462b45d13b5cf6eef57bc62a6334960e90236e40bc1a1621a6f633b79847c", masterKey.PrivKey)
	test.Equal(t, "030c786d673e1a8ca0121c6da7c6c05260528df80fa8de2a503603be7dd78fce8c", masterKey.PubKey)
	test.Equal(t, "L1HKL85ZpMvYfcSsHUXGpjSpZ5wWAw4e3bp5ro2RUcsKQxMRWUSN", masterKey.Wif)
}
...
func TestWallet_DeriveByXprivPath(t *testing.T) {
	...
	test.Equal(t, nil, err)
	test.Equal(t, "xprvA41tKCw5HRJ5Edbsce6zKbqwuDWA9br8nTeJk89iHcQBqthXAukGiiukgWD8dVgmYsoGAoZrA6HsAEy9ZcK73FJEmMLXAp7qptauuq5Fban", info.XPriv)
	test.Equal(t, "xpub6H1EiiTy7nrNT7gLifdzgjngTFLeZ4Zz9gZuYWZKqwwAih2fiT4XGXEEXmktDcULf4bAQEb3JDwNyNS43RnnFbhszpjX9Z7U3hhmtDQbqWT", info.XPub)
	test.Equal(t, "133df64b90c1c03c8b3ee8baca02e7961b0611c81f2381a64588484fc8fef0dc", info.PrivKey)
	test.Equal(t, "025753c8d80dc0e6f35b79fa45eef59d2610fae76c59754ebecff43781eac55ed2", info.PubKey)
	test.Equal(t, "Kws7ckMngrpmRXXSrL7X3MhiK5X5FXTUzT4w8DjhVEM7V8qNTbDR", info.Wif)
}
